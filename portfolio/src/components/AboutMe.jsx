    ...
    return(
        <div className="aboutMe">
            <motion.div className="about-info" variants={textVariant()}>
                ...
                <h2>About Me.</h2>
                <motion.p>Hello, I'm Saurav KC, a graduate in Computer Science from the University of Portsmouth. My journey in this diverse field has led me to discover a increasing appreciation for the art and science of web design and development.
